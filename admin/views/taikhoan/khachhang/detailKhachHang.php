...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-6">
                    <img src="<?= BASE_URL . $khachHang['anh_dai_dien'] ?>" style="width:80%" alt="" onerror="this.onerror=null; this.src='https://media.istockphoto.com/id/1300845620/vector/user-icon-flat-isolated-on-white-background-user-symbol-vector-illustration.jpg?s=612x612&w=0&k=20&c=yBeyba0hUkh14_jgv1OKqIH0CCSWU_4ckRkAoy2p73o='">
                </div>
                <div class="col-6">
                    <div class="container">
                        <table class="table table-borderless">
                            <tbody style="font-size: large;">
                                ...
                                <tr>
                                    <th>Trạng thái:</th>
                                    <td><?= $khachHang['trang_thai'] == 1
                                            ? '<span class="badge badge-success">Active</span>'
                                            : '<span class="badge badge-warning">Inactive</span>'; ?></td>
                                </tr>
                                <!-- maật khẩu quan trọng ko public chỉ để chủ biết cần thì reset -->
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-12">
                    <hr>
                    <h2 class="m-4">Lịch sử mua hàng</h2>
                ...
                <div class="col-12">
                    <hr>
                    <h2 class="m-4">Lịch sử bình luận</h2>
