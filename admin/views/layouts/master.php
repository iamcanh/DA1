...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <?php require_once PATH_VIEW_ADMIN . "layouts/patials/slidebar.php"; ?>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <?php require_once PATH_VIEW_ADMIN . "layouts/patials/topbar.php"; ?>
                <!-- End of Topbar -->
            ...
            <!-- Footer -->
            <?php require_once PATH_VIEW_ADMIN . "layouts/patials/endbar.php"; ?>
            <!-- End of Footer -->
