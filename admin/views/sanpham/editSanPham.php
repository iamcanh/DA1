        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Thông tin Album Sản Phẩm</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($listAnhSanPham as $key => $value) : ?>
                                            <tr id="faqs-row-<?= $key ?>">
                                                ...
                                                <td>
                                                    <img src="<?= BASE_URL . $value['link_hinh_anh'] ?>" style="width:50px; height:50px" alt="" srcset="">
                                                </td>
...
<script>
    ...
    function addfaqs() {
        ...
        html += '<td><img src="https://pethouse.com.vn/wp-content/uploads/2023/03/anh-cho-phoc-soc-o9020208900.jpg" style="width:50px; height:50px" alt=""></td>';
