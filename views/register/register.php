                ...
                <div class="card card-registration my-4">
                    <div class="row g-0">
                        <div class="col-xl-6 d-none d-xl-block">
                            <img src="assets/client/img/balo/img4.webp" alt="Sample photo" class="img-fluid" style="
                      ...
                      border-bottom-left-radius: 0.25rem;" />
                        ...
                        <div class="col-xl-6">
                            <div class="card-body p-md-5 text-black">
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <label class="form-label" for="form3Example90">Mật khẩu</label>
                                ...
                                <div class="d-flex justify-content-end pt-3">
                                    ...
                                    <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-warning btn-lg ms-2">
                                        Submit form
                                    </button>
                                </div>
                            </div>
